(function () {
  ...
  const messages = {
    en: {
      ...
      'helpPage.tools.lead': 'Number keys switch tools. No menus required.',
      ...
      'showcase.toolsCaption': 'Pen, highlighter, laser, arrow, shapes, eraser, text, and colors.',
    ...
    'zh-CN': {
      ...
      'helpPage.tools.lead': '数字键切换工具，无需打开菜单。',
      ...
      'showcase.toolsCaption': '画笔、荧光笔、激光笔、箭头、形状、橡皮擦、文字与颜色。',
