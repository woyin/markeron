(function () {
  ...
  const messages = {
    en: {
      ...
      'helpPage.draw.rightClick': 'Color picker (tap) · Erase (hold)',
      'helpPage.draw.rightClickKeys': 'Right-click / hold',
    ...
    'zh-CN': {
      ...
      'helpPage.draw.colorsKeys': '<kbd>Q</kbd> / <kbd>E</kbd>',
      'helpPage.draw.rightClick': '快速选色（点按）· 按住擦除',
      'helpPage.draw.rightClickKeys': '鼠标右键 / 长按',
