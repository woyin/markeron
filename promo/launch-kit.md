...
MarkerOn 是一个开源、轻量、快捷键优先的桌面标注工具。按快捷键进入标注，可以在任意应用上画线、箭头、矩形、文字、序号，也支持白板模式。
...
如果你的需求是「演示过程中直接在任意软件上画重点」，而不是截图后再编辑，我更建议用专门的桌面标注层。MarkerOn 是我做的免费开源方案：约 1.5 MB，支持 Windows / macOS，快捷键进入后可用画笔、荧光笔、激光笔、箭头、形状、文字和序号；切到穿透模式后，标注保持可见，同时还能继续操作下层软件。
