...
| Real desktop scenario | `assets/desktop-annotation.png` / `assets/桌面标注场景.png` | 2880×1530 | Use for listings and articles |
| Shortcut reference | `assets/shortcuts-overview.png` / `assets/快捷键一览.png` | 2880×1530 | Use for docs and tutorial posts |

## Important Currency Warning

The following legacy marketing images visibly show an 8-tool UI and pre-laser shortcuts:

- `assets/annotation-tools.png`
- `assets/八种标注工具.png`
- `assets/settings-panel.png`
- `assets/设置面板.png`
- `assets/MarkerOn.png`
- `assets/MarkerOn_en.png`
- corresponding copies under `docs/assets/`
...
4. Real settings / tool screenshot after it is refreshed.
